...
function Player() {
  ...
  return (
    <Bounds fit clip observe margin={10}>
      <group ref={player}>
        {/* We've changed the group of meshes below to create an owl character */}
        <group>
          {/* Main Body: A brown cylinder */}
          <mesh position={[0, 0, 10]} castShadow receiveShadow>
            <cylinderGeometry args={[10, 12, 20, 8]} /> {/* [radiusTop, radiusBottom, height, radialSegments] */}
            <meshLambertMaterial color={0x8B4513} flatShading /> {/* SaddleBrown color */}
          </mesh>

          {/* Eyes: Two white circles on the front */}
          <mesh position={[-5, 10.1, 15]} rotation-x={Math.PI / 2}>
            <circleGeometry args={[4, 8]} /> {/* [radius, segments] */}
          ...
          {/* Pupils: Two smaller black circles */}
           <mesh position={[-5, 10.2, 15]} rotation-x={Math.PI / 2}>
          ...
          {/* Beak: A small yellow cone */}
          <mesh position={[0, 11, 12]} rotation-x={Math.PI / 2}>
            <coneGeometry args={[3, 5, 4]} /> {/* [radius, height, segments] */}
            <meshLambertMaterial color={0xFFD700} flatShading /> {/* Gold color for beak */}
          </mesh>

           {/* Ear Tufts */}
           <mesh position={[-7, 0, 21]} rotation-z={-0.5}>
            <coneGeometry args={[3, 6, 4]} />
            <meshLambertMaterial color={0x8B4513} flatShading />
          </mesh>
           <mesh position={[7, 0, 21]} rotation-z={0.5}>
            <coneGeometry args={[3, 6, 4]} />
            <meshLambertMaterial color={0x8B4513} flatShading />
